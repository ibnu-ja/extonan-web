...
class BackupShortlinkUsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('users')->insert(array (
            ...
            array (
                'id' => 8,
                'name' => 'cikimaro123',
                'email' => 'princegokilz@gmail.com',
                'is_admin' => 1,
                'email_verified_at' => NULL,
                'password' => '$2y$10$rnPXlx5tvCBXHmmQOY8r7.QKk./oX67QaaFSGUXMUFKcj/0VCy6r2',
                'remember_token' => 'B6GhcCRLyiPTMoZr1cTmqqHhK5IrvxfkgG7nq0SYkWFn3feEKf8VZgynXAip',
                'created_at' => '2019-12-31 04:54:55',
                'updated_at' => '2019-12-31 04:54:55',
            ),
        ));
